...
function SignIn({ redirectUrl = '/' }: SignInPageProps) {
        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 px-4 py-12 sm:px-6 lg:px-8">
            <div className="w-full max-w-md space-y-8 rounded-xl bg-white p-10 shadow-2xl">
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="mt-8 space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm">
                                <a href="#" className="font-medium text-primary hover:underline hover:underline-offset-4">
                                    Forgot password?
                                </a>
                            </div>
                        </div>
                ...
                <div className="mt-6 text-center text-sm">
                    New to HiVayKings?{' '}
                    <Link href="/auth/signup" className="font-medium text-primary hover:underline hover:underline-offset-4">
...
SignIn.layout = function (page: React.ReactNode) {
